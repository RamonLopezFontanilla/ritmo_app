...
class MockFirebaseFirestore extends _i1.Mock implements _i4.FirebaseFirestore {
  ...
  @override
  set databaseURL(String? value) =>
      super.noSuchMethod(Invocation.setter(#databaseURL, value), returnValueForMissingStub: null);

  @override
  set databaseId(String? value) =>
      super.noSuchMethod(Invocation.setter(#databaseId, value), returnValueForMissingStub: null);
  ...
  @override
  void useFirestoreEmulator(String? host, int? port, {bool? sslEnabled = false, bool? automaticHostMapping = true}) =>
      super.noSuchMethod(
        Invocation.method(
  ...
  _i5.Stream<void> snapshotsInSync() =>
      (super.noSuchMethod(Invocation.method(#snapshotsInSync, []), returnValue: _i5.Stream<void>.empty())
          as _i5.Stream<void>);
  ...
  _i5.Future<void> setIndexConfiguration({
    ...
    List<_i3.FieldOverrides>? fieldOverrides,
      ...
      (super.noSuchMethod(
            Invocation.method(#setIndexConfiguration, [], {#indexes: indexes, #fieldOverrides: fieldOverrides}),
            returnValue: _i5.Future<void>.value(),
            returnValueForMissingStub: _i5.Future<void>.value(),
          )
          as _i5.Future<void>);
...
class MockCollectionReference<T extends Object?> extends _i1.Mock implements _i4.CollectionReference<T> {
  ...
  @override
  String get id =>
      (super.noSuchMethod(Invocation.getter(#id), returnValue: _i6.dummyValue<String>(this, Invocation.getter(#id)))
          as String);

  @override
  String get path =>
      (super.noSuchMethod(Invocation.getter(#path), returnValue: _i6.dummyValue<String>(this, Invocation.getter(#path)))
          as String);
...
class MockWriteBatch extends _i1.Mock implements _i4.WriteBatch {
  ...
  @override
  void delete(_i4.DocumentReference<Object?>? document) =>
      super.noSuchMethod(Invocation.method(#delete, [document]), returnValueForMissingStub: null);

  @override
  void set<T>(_i4.DocumentReference<T>? document, T? data, [_i3.SetOptions? options]) =>
      super.noSuchMethod(Invocation.method(#set, [document, data, options]), returnValueForMissingStub: null);

  @override
  void update(_i4.DocumentReference<Object?>? document, Map<String, dynamic>? data) =>
      super.noSuchMethod(Invocation.method(#update, [document, data]), returnValueForMissingStub: null);
}
